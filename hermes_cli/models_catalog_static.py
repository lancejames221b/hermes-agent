...
_PROVIDER_MODELS: dict[str, list[str]] = {
    ...
    # U221B: trimmed to Lance's 4 in-use models (haiku-4.5/sonnet-5/opus-5/fable-5.1) per his request.
    # Older ids removed here still work if typed/aliased explicitly; this only affects the picker list.
    "anthropic": [
